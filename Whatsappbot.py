...
app = Flask(__name__)
client = MongoClient('mongodb+srv://Vasih:1234@server.nqgtc.mongodb.net/')
...
# About SJBIT
Pentagon_Space = "SJBIT is a private Engineering College"

# Contact Information
contact_info = {
    "Address": "SJBIT, Bangalore",
    "Phone": "+91 7373367802",
    "©": "SJBIT"
}
...
def webhook():
    ...
    if sender_phone_number not in user_state:
        ...
        welcome_messages = [
            "*Welcome to our SJBIT!!! 💐*",
            "*Hello! 😃*\n *I am from GLAD Association, your guide from SJBIT. I can help you with courses, placements, trainings, admissions information, professional development workshops, student welfare, and much more!*",
...
def handle_message(message, phone_number):
    ...
    if message.strip().lower() == "1":
        return "*List of Courses:*\na. B.E in computer science \nb.B.E in Electronics and Communication \nc. B.E in Civil \nd. B.E in Mechanical\ne. B.E in Computer science and engineering(Data Science)\n\nPlease reply with the letter corresponding to the course if you want more details about it:", False
    ...
    if message.strip().lower() == "11":
        return "There is an upcoming SJBIT Campus drive. Register through this link to get connected: https://docs.google.com/forms/d/1XN9qJlIim66HQKS8-jz8uP9gwuTYA2XZRundgGQ6tco/edit", True
